...
abstract class TransferPaymentConfig implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    ...
    /**
     * Initializes internal state of TransferPayment\Model\Base\TransferPaymentConfig object.
     */
    ...
    /**
     * Compares this with another <code>TransferPaymentConfig</code> instance.  If
     * <code>obj</code> is an instance of <code>TransferPaymentConfig</code>, delegates to
     * <code>equals(TransferPaymentConfig)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : TransferPaymentConfigTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildTransferPaymentConfigQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @see TransferPaymentConfig::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildTransferPaymentConfigQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TransferPaymentConfigTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO transfer_payment_config (%s) VALUES (%s)',
    ...
    {
        $pos = TransferPaymentConfigTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['TransferPaymentConfig'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['TransferPaymentConfig'][$this->getPrimaryKey()] = true;
        $keys = TransferPaymentConfigTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getName(),
    ...
    {
        $criteria = new Criteria(TransferPaymentConfigTableMap::DATABASE_NAME);
        $criteria->add(TransferPaymentConfigTableMap::NAME, $this->name);
    ...
    {
        return (string) $this->exportTo(TransferPaymentConfigTableMap::DEFAULT_STRING_FORMAT);
    }
